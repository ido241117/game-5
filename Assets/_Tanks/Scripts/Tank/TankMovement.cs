...
namespace Tanks.Complete
{
    ...
    public class TankMovement : MonoBehaviour
    {
        ...
        public float m_Speed = 18f;                 // How fast the tank moves forward and back. (Increased from 12)
        [Tooltip("The speed in deg/s that tank will rotate at")]
        public float m_TurnSpeed = 270f;            // How fast the tank turns in degrees per second. (Increased from 180)
