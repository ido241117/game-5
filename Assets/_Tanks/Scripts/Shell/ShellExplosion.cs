...
namespace Tanks.Complete
{
    public class ShellExplosion : MonoBehaviour
    {
        ...
        [HideInInspector] public float m_DamageMultiplier = 1f;               // Damage multiplier from cheat system (One Hit Kill)
        ...
        private void OnTriggerEnter (Collider other)
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                // CHEAT: Apply damage multiplier if this shell was fired by a tank with One Hit Kill active
