...
namespace Tanks.Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        public void StartGame(PlayerData[] playerData)
        {
            ...
            // DISABLED: No longer using map selection - using linear level progression
            // string selectedMap = MapSelectionUI.SelectedMapScene;
            // if (!string.IsNullOrEmpty(selectedMap) && SceneManager.GetActiveScene().name != selectedMap)
            // {
            //     Debug.Log("Loading selected map: " + selectedMap);
            //     SceneManager.LoadScene(selectedMap);
            // }
            
            // Just start the game in current scene
        ...
        private IEnumerator GameLoop ()
        {
            ...
            {
                // If there is a game winner, return to the current scene to show map selection again
